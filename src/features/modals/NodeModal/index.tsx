      ...
      <Stack pb="sm" gap="sm">
        <Stack gap="xs">
                  ...
                  <>
                    <Button
                      ...
                      onClick={() => {
                        setError(null);
                        try {
                          // try to parse edited text; if it fails treat as string
                          let value: any;
                          try {
                            value = JSON.parse(editedText);
                          } catch (e) {
                            value = editedText;
                          }

                          const edits = modify(json, nodeData.path ?? [], value, {
          ...
          <ScrollArea.Autosize mah={250} maw={600}>
            ...
            {error && <Text fz="xs" color="red">{error}</Text>}
          </ScrollArea.Autosize>
        </Stack>
        <Text fz="xs" fw={500}>
          JSON Path
